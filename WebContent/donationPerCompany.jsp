...
<%
	    ...
	    try{
	    	...
	    	String selectStatement = "SELECT transaction.companyId, sum(transaction.total) AS donationTotal, company.name FROM transaction, company WHERE company.companyId = transaction.companyId GROUP BY companyId";
	        ...
	        rs = query.executeQuery("SELECT transaction.companyId, sum(transaction.total) AS donationTotal, company.name FROM transaction, company WHERE company.companyId = transaction.companyId GROUP BY companyId limit "+limitstart+","+rows);  
