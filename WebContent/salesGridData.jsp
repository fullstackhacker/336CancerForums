...
<%
	    ...
	    try{
	    	...
	    	String selectStatement = "SELECT orderId,datetimeOrdered,total,customerId,companyId FROM transaction";
	        ...
	        rs = query.executeQuery("SELECT orderId,datetimeOrdered,total,customerId,companyId FROM transaction limit "+limitstart+","+rows);  
	       ...
	       while(rs.next())
	           {
	                cellobj.put("orderId",rs.getString(1));
